 ...
 *
 */
public class ElementTextareaImp extends Element {
	...
	public Map<String, String> getInitHtml(long stateKey, String formId, boolean renderEmpty, String value, String userLastSaveVal, String domId, String inputAttribute,
		...
		html.put(layoutBookMark,
				isLabel(isHidden) + 
				"<textarea class=\"" + disabled + "\" maxlength=\"2000\" autocomplete=\"off\"  id=\"" + domId + "\"  placeholder=\""+placeHolder+"\" style=\"" + hidden + "border-radius: 5px;vertical-align: middle;" + width_ + height_ + "\" "
						+ inputAttribute + getAttributes(isDisabled, isMandatory, isHidden)
						+" element=\"ElementGeneral\">" + value + "</textarea>"+ isLabelEnd());
