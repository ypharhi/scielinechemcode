/*
 ...
 Date: 2015-10-17
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(m,v,E){m instanceof String&&(m=String(m));for(var D=m.length,S=0;S<D;S++){var ua=m[S];if(v.call(E,ua,S,m))return{i:S,v:ua}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(m,v,E){m!=Array.prototype&&m!=Object.prototype&&(m[v]=E.value)};
$jscomp.getGlobal=function(m){return"undefined"!=typeof window&&window===m?m:"undefined"!=typeof global&&null!=global?global:m};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(m,v,E,D){if(v){E=$jscomp.global;m=m.split(".");for(D=0;D<m.length-1;D++){var S=m[D];S in E||(E[S]={});E=E[S]}m=m[m.length-1];D=E[m];v=v(D);v!=D&&null!=v&&$jscomp.defineProperty(E,m,{configurable:!0,writable:!0,value:v})}};
$jscomp.polyfill("Array.prototype.find",function(m){return m?m:function(m,E){return $jscomp.findInternal(this,m,E).v}},"es6","es3");
(function(m,v){"object"===typeof module&&"object"===typeof module.exports?module.exports=m.document?v(m,!0):function(m){if(!m.document)throw Error("jQuery requires a window with a document");return v(m)}:v(m)})("undefined"!==typeof window?window:this,function(m,v){function E(a){var b=!!a&&"length"in a&&a.length,d=c.type(a);return"function"===d||c.isWindow(a)?!1:"array"===d||0===b||"number"===typeof b&&0<b&&b-1 in a}function D(a,b,d){if(c.isFunction(b))return c.grep(a,function(a,c){return!!b.call(a,
...
f);var g=f.events;if(g)for(d in delete a.handle,a.events={},g)for(f=0,e=g[d].length;f<e;f++)c.event.add(b,d,g[d][f]);a.data&&(a.data=c.extend({},a.data))}}function da(a,b,d,e){b=vb.apply([],b);var f,g=0,h=a.length,l=h-1,k=b[0],n=c.isFunction(k);if(n||1<h&&"string"===typeof k&&!q.checkClone&&jc.test(k))return a.each(function(c){var f=a.eq(c);n&&(b[0]=k.call(this,c,f.html()));da(f,b,d,e)});if(h){var r=mb(b,a[0].ownerDocument,!1,a,e);var t=r.firstChild;1===r.childNodes.length&&(r=t);if(t||e){var m=c.map(A(r,
"script"),sb);for(f=m.length;g<h;g++)t=r,g!==l&&(t=c.clone(t,!0,!0),f&&c.merge(m,A(t,"script"))),d.call(a[g],t,g);if(f)for(r=m[m.length-1].ownerDocument,c.map(m,tb),g=0;g<f;g++)t=m[g],pb.test(t.type||"")&&!c._data(t,"globalEval")&&c.contains(r,t)&&(t.src?c._evalUrl&&c._evalUrl(t.src):c.globalEval((t.text||t.textContent||t.innerHTML||"").replace(kc,"")));r=t=null}}return a}function wb(a,b,d){for(var e=b?c.filter(b,a):a,f=0;null!=(b=e[f]);f++)d||1!==b.nodeType||c.cleanData(A(b)),b.parentNode&&(d&&c.contains(b.ownerDocument,
...
b.push(h);return g}function v(a,c,d,f,g,h){f&&!f[z]&&(f=v(f));g&&!g[z]&&(g=v(g,h));return e(function(e,h,u,y){var l,k=[],n=[],W=h.length,M;if(!(M=e)){M=c||"*";for(var m=u.nodeType?[u]:u,r=[],t=0,q=m.length;t<q;t++)b(M,m[t],r);M=r}M=!a||!e&&c?M:E(M,k,a,u,y);m=d?g||(e?a:W||f)?[]:h:M;d&&d(M,m,u,y);if(f){var p=E(m,n);f(p,[],u,y);for(u=p.length;u--;)if(l=p[u])m[n[u]]=!(M[n[u]]=l)}if(e){if(g||a){if(g){p=[];for(u=m.length;u--;)(l=m[u])&&p.push(M[u]=l);g(null,m=[],p,y)}for(u=m.length;u--;)(l=m[u])&&-1<(p=
g?R(e,l):k[u])&&(e[p]=!(h[p]=l))}}else m=E(m===h?m.splice(W,m.length):m),g?g(null,h,m,y):H.apply(h,m)})}function A(a){var b,c,d=a.length,e=C.relative[a[0].type];var f=e||C.relative[" "];for(var g=e?1:0,h=p(function(a){return a===b},f,!0),u=p(function(a){return-1<R(b,a)},f,!0),l=[function(a,c,d){a=!e&&(d||c!==O)||((b=c).nodeType?h(a,c,d):u(a,c,d));b=null;return a}];g<d;g++)if(f=C.relative[a[g].type])l=[p(K(l),f)];else{f=C.filter[a[g].type].apply(null,a[g].matches);if(f[z]){for(c=++g;c<d&&!C.relative[a[c].type];c++);
return v(1<g&&K(l),1<g&&q(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(V,"$1"),f,g<c&&A(a.slice(g,c)),c<d&&A(a=a.slice(c)),c<d&&q(a))}l.push(f)}return K(l)}function G(a,c){var d=0<c.length,f=0<a.length,g=function(e,g,h,u,l){var y,k,n=0,W="0",M=e&&[],m=[],r=O,t=e||f&&C.find.TAG("*",l),p=ka+=null==r?1:Math.random()||.1,q=t.length;for(l&&(O=g===w||g||l);W!==q&&null!=(y=t[W]);W++){if(f&&y){var Va=0;g||y.ownerDocument===w||(xa(y),h=!Z);for(;k=a[Va++];)if(k(y,g||w,h)){u.push(y);break}l&&
(ka=p)}d&&((y=!k&&y)&&n--,e&&M.push(y))}n+=W;if(d&&W!==n){for(Va=0;k=c[Va++];)k(M,m,g,h);if(e){if(0<n)for(;W--;)M[W]||m[W]||(m[W]=ca.call(u));m=E(m)}H.apply(u,m);l&&!e&&0<m.length&&1<n+c.length&&b.uniqueSort(u)}l&&(ka=p,O=r);return M};return d?e(g):g}var x,O,L,Q,w,aa,Z,P,ya,Ca,D,z="sizzle"+1*new Date,B=a.document,ka=0,S=0,J=c(),U=c(),N=c(),T=function(a,b){a===b&&(Q=!0);return 0},Y={}.hasOwnProperty,F=[],ca=F.pop,ea=F.push,H=F.push,da=F.slice,R=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===
...
0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:n(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};C.pseudos.nth=C.pseudos.eq;for(x in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})C.pseudos[x]=l(x);for(x in{submit:!0,reset:!0})C.pseudos[x]=k(x);m.prototype=C.filters=C.pseudos;C.setFilters=new m;var ia=b.tokenize=function(a,c){var d,e,f,g,h;if(g=U[a+" "])return c?0:g.slice(0);g=a;var l=[];for(h=C.preFilter;g;){if(!k||(d=na.exec(g)))d&&(g=g.slice(d[0].length)||g),l.push(e=[]);var k=!1;
...
a||[],!1))},not:function(a){return this.pushStack(D(this,a||[],!0))},is:function(a){return!!D(this,"string"===typeof a&&Ob.test(a)?c(a):a||[],!1).length}});var vc=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(c.fn.init=function(a,b,d){if(!a)return this;d=d||Qb;if("string"===typeof a){var e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:vc.exec(a);if(!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof c?b[0]:b,c.merge(this,c.parseHTML(e[1],
...
(k=m.events)){b=(b||"").match(T)||[""];for(l=b.length;l--;){var p=Sb.exec(b[l])||[];var q=n=p[1];var E=(p[2]||"").split(".").sort();if(q){var K=c.event.special[q]||{};q=(e?K.delegateType:K.bindType)||q;var v=k[q]||[];p=p[2]&&new RegExp("(^|\\.)"+E.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=v.length;g--;){var A=v[g];!f&&n!==A.origType||d&&d.guid!==A.guid||p&&!p.test(A.namespace)||e&&e!==A.selector&&("**"!==e||!A.selector)||(v.splice(g,1),A.selector&&v.delegateCount--,K.remove&&K.remove.call(a,A))}h&&
!v.length&&(K.teardown&&!1!==K.teardown.call(a,E,m.handle)||c.removeEvent(a,q,m.handle),delete k[q])}else for(q in k)c.event.remove(a,q+b[l],d,e,!0)}c.isEmptyObject(k)&&(delete m.handle,c._removeData(a,"events"))}},trigger:function(a,b,d,e){var f,g,h=[d||p],l=ja.call(a,"type")?a.type:a;var k=ja.call(a,"namespace")?a.namespace.split("."):[];var n=f=d=d||p;if(3!==d.nodeType&&8!==d.nodeType&&!Rb.test(l+c.event.triggered)){-1<l.indexOf(".")&&(k=l.split("."),l=k.shift(),k.sort());var r=0>l.indexOf(":")&&
...
l=void 0;f=e||"";x.readyState=0<a?4:0;e=200<=a&&300>a||304===a;if(d){var r=n;for(var t=x,w,L,z,B,D=r.contents,Q=r.dataTypes;"*"===Q[0];)Q.shift(),void 0===L&&(L=r.mimeType||t.getResponseHeader("Content-Type"));if(L)for(B in D)if(D[B]&&D[B].test(L)){Q.unshift(B);break}if(Q[0]in d)z=Q[0];else{for(B in d){if(!Q[0]||r.converters[B+" "+Q[0]]){z=B;break}w||(w=B)}z=z||w}z?(z!==Q[0]&&Q.unshift(z),r=d[z]):r=void 0}a:{d=n;w=r;L=x;z=e;var H;t={};D=d.dataTypes.slice();if(D[1])for(N in d.converters)t[N.toLowerCase()]=
d.converters[N];for(B=D.shift();B;){d.responseFields[B]&&(L[d.responseFields[B]]=w);!G&&z&&d.dataFilter&&(w=d.dataFilter(w,d.dataType));var G=B;if(B=D.shift())if("*"===B)B=G;else if("*"!==G&&G!==B){var N=t[G+" "+B]||t["* "+B];if(!N)for(H in t)if(r=H.split(" "),r[1]===B&&(N=t[G+" "+r[0]]||t["* "+r[0]])){!0===N?N=t[H]:!0!==t[H]&&(B=r[0],D.unshift(r[1]));break}if(!0!==N)if(N&&d["throws"])w=N(w);else try{w=N(w)}catch(uc){r={state:"parsererror",error:N?uc:"No conversion from "+G+" to "+B};break a}}}r=
{state:"success",data:w}}if(e)if(n.ifModified&&((k=x.getResponseHeader("Last-Modified"))&&(c.lastModified[O]=k),(k=x.getResponseHeader("etag"))&&(c.etag[O]=k)),204===a||"HEAD"===n.type)k="nocontent";else if(304===a)k="notmodified";else{k=r.state;var K=r.data;var J=r.error;e=!J}else if(J=k,a||!k)k="error",0>a&&(a=0);x.status=a;x.statusText=(b||k)+"";e?v.resolveWith(p,[K,k,x]):v.rejectWith(p,[x,k,J]);x.statusCode(E);E=void 0;h&&q.trigger(e?"ajaxSuccess":"ajaxError",[x,n,e?K:J]);A.fireWith(p,[x,k]);
h&&(q.trigger("ajaxComplete",[x,n]),--c.active||c.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,l,k,n=c.ajaxSetup({},b),p=n.context||n,q=n.context&&(p.nodeType||p.jquery)?c(p):c.event,v=c.Deferred(),A=c.Callbacks("once memory"),E=n.statusCode||{},D={},H={},F=0,G="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===F){if(!k)for(k={};b=Sc.exec(f);)k[b[1].toLowerCase()]=b[2];b=k[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===
F?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();F||(a=H[c]=H[c]||a,D[a]=b);return this},overrideMimeType:function(a){F||(n.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>F)for(b in a)E[b]=[E[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||G;l&&l.abort(a);d(0,a);return this}};v.promise(x).complete=A.add;x.success=x.done;x.error=x.fail;n.url=((a||n.url||eb)+"").replace(Rc,"").replace(Uc,ta[1]+"//");n.type=b.method||b.type||n.method||n.type;n.dataTypes=
...
("*"!==n.dataTypes[0]?", "+$b+"; q=0.01":""):n.accepts["*"]);for(e in n.headers)x.setRequestHeader(e,n.headers[e]);if(n.beforeSend&&(!1===n.beforeSend.call(p,x,n)||2===F))return x.abort();G="abort";for(e in{success:1,error:1,complete:1})x[e](n[e]);if(l=Jb(Qa,n,b,x)){x.readyState=1;h&&q.trigger("ajaxSend",[x,n]);if(2===F)return x;n.async&&0<n.timeout&&(g=m.setTimeout(function(){x.abort("timeout")},n.timeout));try{F=1,l.send(D,d)}catch(L){if(2>F)d(-1,L);else throw L;}}else d(-1,"No Transport");return x},
