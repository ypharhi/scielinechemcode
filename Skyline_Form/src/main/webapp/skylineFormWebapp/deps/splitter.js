...
$.fn.splitter = function(args){
	...
	return this.each(function() {
		...
		function endSplitMouse(evt) {
			...
			/* SKYLINE: added event on split end */
			$(document).trigger('end_split_event');
		}
		...
		{			
		    //alert(args.sizeLeft);
		    //initPos = Math.round(((splitter[0][opts.pxSplit] - splitter._PBA - bar._DA) / 2) - args.sizeOfset);
		    initPos = args.sizeLeft
		    //alert(initPos);
		}
