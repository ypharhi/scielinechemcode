...
.webix_accordionitem_button{float:right;position:relative;height:11px;width:11px;margin:11px}
...
.webix_popup_text{margin:0 0 5px;padding-top:25px;font-size:12px;color:#1e2022;min-height:60px}
...
.webix_cell.webix_dtable_colrow,.webix_cell.webix_dtable_subrow,.webix_cell.webix_dtable_subview{position:absolute;left:0;top:0;background-color:#fff;width:100%;padding-right:28px;padding-left:10px;padding-top:1px;border-bottom:1px solid #d5d9db}
.webix_dtable_subrow{border-top:1px solid #d5d9db;text-align:right}
.webix_dtable_subview{background:#d5d9db;border-top:1px solid #d5d9db;padding:0 0 0 10px;box-sizing:border-box}
...
.webix_property_col_ind{float:right;border:1px solid #9da8ad;border-radius:2px;width:30px;cursor:pointer;height:13px;margin:3px 10px 3px 0}
...
.webix_el_label{color:#1e2022;line-height:24px;padding:2px}
...
.webix_inp_counter_next,.webix_inp_counter_prev{padding-left:6px;background:#e6e6e6;color:#1e2022;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_el_textarea textarea{border:1px solid #9da8ad;height:100%;margin:0;padding:5px 10px;color:#1e2022;resize:none;font-size:12px;font-family:Tahoma,Arial}
...
.webix_segment_N{border:1px solid #9da8ad;height:100%;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_segment_N:first-child{-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
...
.webix_item_tab{display:table-cell;text-align:center;vertical-align:middle;overflow:hidden;cursor:pointer;border:1px solid #9da8ad;border-left-width:0;color:#1e2022;background:#f2f2f2;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
...
.webix_menu-x{background:#d8eaf6}
...
.webix_forminput legend{color:#1e2022;line-height:24px;padding:2px 7.5px 2px 2px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;font-family:Tahoma,Arial;float:left}
.webix_slider_box{position:relative;padding:10px 10px 0;height:100%;float:left;border-radius:5px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;margin-top:-8px}
...
.webix_slider_box .webix_slider_left{height:8px;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0;background:#E6E6E6}
.webix_slider_box .webix_slider_right{height:8px;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_slider_box .webix_slider_handle{-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0;border:1px solid #9da8ad;width:11px;height:11px;top:6.5px;color:#1e2022;background:#d8eaf6}
...
.webix_menu-x .webix_list_item .webix_submenu_icon{border-color:#394145 transparent transparent}
...
.webix_slider_vertical .webix_slider_box .webix_slider_left,.webix_slider_vertical .webix_slider_box .webix_slider_right{-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
