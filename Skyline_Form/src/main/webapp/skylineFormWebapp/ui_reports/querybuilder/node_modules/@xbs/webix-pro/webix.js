...
(c) XB Software Ltd.
*/
window.webix||(webix={}),webix.version="5.1.0",webix.codebase="./",webix.name="core",webix.cdn="//cdn.webix.com",webix.clone=function(t){var e=webix.clone.a;return e.prototype=t,new e},webix.clone.a=function(){},webix.extend=function(t,e,i){if(t.$protoWait)return webix.PowerArray.insertAt.call(t.$protoWait,e,1),
...
return!0}}else i=t;var a="all"===e?[]:!1,h="parent"===e?this.gG:this.hG,o=this.iG(i,h,a);return"all"===e?a:o},hG:function(t){return t.getChildViews()},gG:function(t){var e=t.getParentView();return e?[e]:[]},iG:function(t,e,i){for(var s=e(this),n=0;n<s.length;n++)if(t(s[n])){if(!i)return s[n];i.push(s[n]);
}else{var r=s[n].iG(t,e,i);if(r)return r}return null},isVisible:function(t,e){if(this.s.hidden)return t&&(this.Yb||(this.Yb=[],this.Zb={}),this.Zb[t]||(this.Zb[t]=!0,this.Yb.push(t))),!1;var i=this.getParentView();return i?i.isVisible(t,this.s.id):!0},isEnabled:function(){if(this.$b)return!1;var t=this.getParentView();
return t?t.isEnabled():!0},disable:function(){webix.html.remove(this.$b),this.s.disabled=!0,this.$b=webix.html.create("div",{"class":"webix_disabled"}),window.getComputedStyle&&(this._b=window.getComputedStyle(this.x,null).getPropertyValue("position")),"absolute"!=this._b&&(this.x.style.position="relative"),
...
return this.VC(t,!1)},VC:function(t){return t},$setValue:function(t){(this.getInputNode()||{}).value=t},getValue:function(){var t=this.se?this.$getValue():this.s.value;return"undefined"==typeof t?"":t},$getValue:function(){return this.s.value||""},focus:function(){if(!this.s.disabled){var t=this.getInputNode();
t&&t.focus&&t.focus()}},blur:function(){var t=this.getInputNode();t&&t.blur&&t.blur()},getInputNode:function(){return this.y.getElementsByTagName("input")[0]||this.y.getElementsByTagName("button")[0]},re:function(){for(var t=0;t<this.y.childNodes.length;t++)if(this.y.childNodes[t].className.indexOf("webix_el_box")>=0)return this.y.childNodes[t];
...
return"<button type='button'  style='height:100%;width:100%;' class='webix_icon_button'><span class='webix_icon fa-"+t.icon+" '></span>"+(t.badge?"<span class='webix_badge'>"+t.badge+"</span>":"")+"</button>"},width:33},oe:function(){}},webix.ui.button),webix.protoUI({name:"text",Ce:!0,De:function(){
this.Ce&&(this._E||webix.UE(this.getInputNode(),"change",this.Xy,{bind:this}),this.s.suggest&&webix.$$(this.s.suggest).linkInput(this))},Xy:function(){var t=this.getValue();t!=this.s.value?this.setValue(t,!0):this.nH&&this.$setValue(t)},$skin:function(){this.defaults.height=webix.skin.$active.inputHeight,
...
this.refresh()},kf:function(t,e){var i=t.from,s=!0,n=!1;if(!i&&0!==i&&this.order[0]){if(this.ff){n={};for(var r=0;r<this.order.length;r++)n[this.order[r]]=!0}s=!1,i=this.order.length}else i=i||0;for(var a=0,r=0;r<e.length;r++){var h=this.driver.getDetails(e[r]),o=this.id(h);this.pull[o]?s&&this.order[a+i]&&a++:(this.order[a+i]=o,
...
y:this.y.parentNode.scrollTop}},scrollTo:function(t,e){webix.Touch&&webix.Touch.$active?(e=Math.max(0,Math.min(e,this.y.offsetHeight-this.dc)),t=Math.max(0,Math.min(t,this.y.offsetWidth-this.bc)),webix.Touch.Nf(this.y,-t,-e,this.s.scrollSpeed||"100ms")):(this.y.parentNode.scrollLeft=t,this.y.parentNode.scrollTop=e);
},Jf:function(){if(-1!=this.s.scroll.toString().indexOf("x")){var t=this.y.scrollWidth;t&&(this.y.style.width="100%",this.y.style.width=this.y.scrollWidth+"px")}if(webix.Touch&&webix.Touch.$active&&this.Kf){webix.Touch.Of(),webix.Touch.Pf();var e=this.getScrollState(),i=this.y.offsetWidth-this.$width-e.x,s=this.y.offsetHeight-this.$height-e.y;
...
this.pull[r]=n),this.Pg(n,i,0,a,t.from?1*t.from+s:0)}var h=this.pull[i]||{},o=this.branch[i]||[];h.$count=o.length,delete h.webix_kids,t.size&&t.size!=o.length&&(o[t.size]=null)},Pg:function(t,e,i,s,n){t.$count=0,t.$parent="0"!=e?e:0,t.$level=i||("0"!=e?this.pull[e].$level+1:1);var r=this.branch[t.$parent];
...
return e?this.FA(this.data.pull[e]):this.s.rowHeight},Tj:function(t,e){if(this.s.fixedRowHeight)return(e-t)*this.s.rowHeight;for(var i=0;e>t;t++)i+=this.Uj(t);return i},ug:function(t,e){var i;1==arguments.length&&(e=t.column,t=t.row);for(var s=this.getItem(t),n=this.getColumnConfig(e),r=0,a=0,h=0;h<this.fj.length;h++){
(h==this.s.leftSplit||h==this.Fj)&&(r=0);var o=this.fj[h];if(o.id==e){var l=h<this.s.leftSplit?0:h>=this.Fj?2:1;a=this.Vf.childNodes[l].firstChild;break}r+=o.width}return i=this.getIndexById(t)<this.s.topSplit?this.Tj(0,this.getIndexById(t)):this.Tj((this.ak||0)-this.s.topSplit,this.getIndexById(t))+(this.ck||0),
...
e&&(this.callEvent("onScrollY",[]),this.callEvent("onAfterScroll",[]))},oH:function(t){this.Vf.childNodes[1].scrollLeft=this.bk=t,this.s.header&&(this.I.childNodes[1].scrollLeft=t),this.s.footer&&(this.cj.childNodes[1].scrollLeft=t)},kk:function(t){var e=this.bk!==t;this.oH(t),this.s.prerender===!1&&this.vj(this.tk?!1:!0),
webix.env.$customScroll&&webix.CustomScroll.sk(this.Vf),e&&(this.callEvent("onScrollX",[]),this.callEvent("onAfterScroll",[]))},Xj:function(t){if(t)return[0,this.fj.length];for(var e=this.bk,i=this.s.leftSplit;e>0&&this.fj.length-1>i;)e-=this.fj[i].width,i++;var s=i;for(e&&i--,e+=this.Yj;e>0&&s<this.Fj;)e-=this.fj[s].width,
s++;return[i,s]},getVisibleCount:function(){return Math.floor(this.Vj/this.config.rowHeight)},Sj:function(t){var e=this.jk,i=0,s=this.count(),n=this.s.pager;if(n){var i=n.page*n.size,s=Math.min(s,i+n.size);n.level&&(i=this.data.$min,s=this.data.$max)}if(this.s.autoheight)return[i,s,0];if(t)return[i,s,0];
var r=i,a=this.s.topSplit||0;a&&(r+=a);var h=this.s.fixedRowHeight?this.s.rowHeight:0;if(h){var o=Math.ceil(e/h);e-=o*h,r+=o}else for(;e>0;)e-=this.Uj(r),r++;var l=r>0&&e?-(this.Uj(r-1)+e):0,c=r;if(e&&r--,e+=(this.Vj||this.dc)-(this.xD||0),h){var o=Math.ceil(e/h);e-=o*h,c+=o}else for(;e>0&&s>c;)e-=this.Uj(c),
c++;return c>s&&(c=s),[r,c,l]},Kv:function(t){var e=this.getItem(t),i=this.getIndexById(t),s=this.Sj(),n=this.config.topSplit,r="";if(i>=n){if(i<s[0]||i>=s[1])return;i-=s[0]-n}else r=i==n-1?" webix_topcell webix_last_topcell":" webix_topcell";for(var a=this.Xj(),h=0;h<this.fj.length;h++){var o=this.fj[h];
if(h<this.Fj&&h>=this.s.leftSplit&&(h<a[0]||h>a[1])&&(o.qk=-999),o.attached&&o.node){var l=o.node.childNodes[i],c=this.Ek(e,this.fj[h],0);l.innerHTML=c,l.className=this.Mv(this.fj[h],c,e,t)+r}}},vj:function(t,e){if(this.fj.length){e&&this.uk();var i=this.Xj(this.s.prerender),s=this.Sj(this.s.prerender===!0);
if(t){for(var n=this.s.leftSplit;n<i[0];n++)this.vk(n,e);for(var n=i[1];n<this.Fj;n++)this.vk(n,e)}this.wk=[];for(var r=0,n=0;n<this.s.leftSplit;n++)r+=this.xk(n,s,e);for(var n=i[0];n<i[1];n++)r+=this.xk(n,s,e,n==i[0]);for(var n=this.Fj;n<this.fj.length;n++)r+=this.xk(n,s,e);this.yk(s[0],s[1],e),this.zk(s);
}},Ak:function(t,e){this.Bk=t,this.Ck=e,webix.html.remove(this.gj),this.gj=[]},dF:function(){if(this.s.prerender&&this.GA){var t=this.getScrollState();this.GA.style.top="-"+(t.y||0)+"px"}},yk:function(t,e,i){if(this.GA&&(this.GA.style.top=this.ck+"px"),i||t!=this.Bk||e!=this.Ck){if(this.Ak(t,e),this.Dk){
this.Dk=!1;for(var s=0;s<this.wk.length;s++){var n,r=this.wk[s],a=this.getItem(r.id);n="function"==typeof a.$row?a.$row.call(this,a,this.type):this.Ek(a,this.getColumnConfig(a.$row),s);var h=this.gj[s]=webix.html.create("DIV",null,n);h.className="webix_cell "+(a.$sub?"webix_dtable_sub"+(this.s.subview?"view":"row"):"webix_dtable_colrow"+(a.$row?" webix_topcell":"")),
h.setAttribute("column",0),h.setAttribute("row",r.index);var o=a.$height||this.s.rowHeight;a.$subopen?h.style.height=a.$subHeight+"px":h.style.height=o+"px",h.style.paddingRight=webix.ui.scrollSize+"px";var l=this.wk[s].index<this.config.topSplit?-this.ck:0;h.style.top=l+r.top+(a.$subopen?o-1:0)+"px",
this.GA||(this.GA=webix.html.create("DIV"),this.GA.style.position="relative",this.GA.style.top=this.ck+"px",this.Vf.appendChild(this.GA)),this.GA.appendChild(h),this.attachEvent("onSyncScroll",function(t,e,i){webix.Touch.Nf(this.GA,0,e,i)}),this.s.subview&&this.callEvent("onSubViewRender",[a,h])}}}else if(this.config.topSplit)for(var s=0;s<this.wk.length;s++){
var h=this.gj[s];this.wk[s].index<this.config.topSplit&&(h.style.top=this.wk[s].top-this.ck+"px")}},zk:function(t){var e=this.s.pager,i=this.s.datafetch,s=!this.Fk||t[0]>=this.Fk;if(this.Fk=t[0],this.Gk){if(e&&(!i||i>=e.size)&&this.Hk([0,e.size*e.page],Math.max(i,e.size),!0))return this.Gk=null;this.Ik(this.Gk,s),
this.Gk=null}else if(this.s.loadahead){this.Hk(t,this.s.loadahead,s)}},Hk:function(t,e,i){var s=t[1],n=s+e;i||(s=t[0]-e,n=t[0]),0>s&&(s=0),n=Math.min(n,this.data.order.length-1);for(var r=!1,a=s;n>a;a++)this.data.order[a]||(r?(r.last=a,r.count=a-s):r={start:a,count:n-s});return r?(this.Ik(r,i),!0):void 0;
},Ik:function(t,e){var i=Math.max(t.count,this.s.datafetch||this.s.loadahead||0),s=e?t.start:t.last-i+1;this.cf(t.count,t.start)||this.loadNext(i,s)},Zy:function(t){if(webix.env.isSafari){var e,i,s,n,r=[this.Zj,this.Wj];for(e=0;2>e;e++)n=r[e],n&&n.Yy&&n.Yy.parentNode==t&&(i=n.Yy);i&&(this.$y&&webix.html.remove(this.$y),
...
return"<input class='webix_table_checkbox' type='checkbox' "+n+">"},radio:function(t,e,i,s){var n=i==s.checkValue?'checked="true"':"";return"<input class='webix_table_radio' type='radio' "+n+">"},editIcon:function(){return"<span class='webix_icon fa-pencil'></span>"},trashIcon:function(){return"<span class='webix_icon fa-trash'></span>";
}},type_setter:function(t){return this.types&&this.types[t]?(this.type=webix.clone(this.types[t]),this.type.css&&(this.w.className+=" "+this.type.css)):webix.type(this,t),this.type.on_click&&webix.extend(this.on_click,this.type.on_click),t},xk:function(t,e,i,s){var n=this.fj[t];if(!n.attached){var r=t<this.s.leftSplit?0:t>=this.Fj?2:1;
this.Vf.childNodes[r].firstChild.appendChild(n.node),n.attached=!0,n.split=r}if(this.ak=e[0],this.ck=0,this.aC=e[2],this.s.scrollAlignY?e[1]==this.data.order.length||this.data.$pagesize&&e[1]%this.data.$pagesize===0?n.node.style.top=(this.ck=e[2])+"px":n.Jk&&(n.node.style.top="0px"):(this.ck=e[2],n.node.style.top=e[2]+"px"),
!(i||n.qk!=e[0]||n.Kk!=e[1]||this.s.topSplit&&n.ck!=this.ck))return 0;for(var a="",h=this.s.columns[t],o={row:this.s.rowHeight,total:0,single:s},l=0;l<this.s.topSplit;l++)a+=this.yD(l,h,e,o,-this.ck);for(var l=Math.max(e[0],this.s.topSplit);l<e[1];l++)a+=this.yD(l,h,e,o,-1);return this.Zy(n.node),n.node.innerHTML=a,
n.qk=e[0],n.Kk=e[1],n.Jk=e[2],n.ck=this.ck,1},yD:function(t,e,i,s,n){var r,a=this.data.order[t],h=this.data.getItem(a),o="";if(h){var l=" role='gridcell' aria-rowindex='"+(t+1)+"' aria-colindex='"+(this.getColumnIndex(e.id)+1)+"'"+(h.$count||h.$sub?" aria-expanded='"+(h.open||h.$subopen?"true":"false")+"'":"")+(h.$level?" aria-level='"+h.$level+"'":"");
...
webix.event(document.body,"dragstart",function(t){return webix.html.preventEvent(t)}),webix.event(document.body,"touchstart",function(t){if(!i.Xf&&!i.cm&&webix.env.isSafari){var e=t.srcElement.tagName.toLowerCase();return"input"==e||"textarea"==e||"select"==e||"label"==e?!0:(i.im=!0,webix.html.preventEvent(t));
}}),i.Of(),i.jm=[null,null],i.$active=!0},Of:function(){i.km=i.lm=i.mm=i.bC=null,i.nm=i.om=i.pm=this.qm=null,i.rm={sm:0,tm:0,um:0},i.vm&&(webix.html.removeCss(i.vm,"webix_touch"),i.vm=null),window.clearTimeout(i.wm),i.xm=!0,i.ym=!0,i.zm=!0,i.Am||i.Pf()},fm:function(t){if(i.km){if(i.nm){var e=i.Mf(i.om),s=e.e,n=e.f,r=i.config.finish,a=i.Bm(t,!0),h=webix.$$(i.om),o=h&&h.$scroll?h.$scroll.gravity:i.config.gravity;
if(a.um){var l=s+o*a.sm/a.um,c=n+o*a.tm/a.um,u=i.jm[0]?i.Cm(l,!1,!1,i.pm.dx,i.pm.px):s,d=i.jm[1]?i.Cm(c,!1,!1,i.pm.dy,i.pm.py):n,f=Math.max(Math.abs(u-s),Math.abs(d-n));150>f&&(r=r*f/150),(u!=s||d!=n)&&(r=Math.round(r*Math.max((u-s)/(l-s),(d-n)/(c-n))));var b={e:u,f:d},h=webix.$$(i.om);h&&h.adjustScroll&&h.adjustScroll(b),
...
}return i.Dm&&i.Dm.Mm(e),e},Cm:function(t,e,i,s,n){if(t===i)return t;var r=Math.abs(t-i),a=r/(t-i);if(t>0)return e?i+a*Math.sqrt(r):0;var h=s-n;return 0>h+t?e?i-Math.sqrt(-(t-i)):-h:t},Nm:function(t){if(!t.scroll_enabled){t.scroll_enabled=!0,t.parentNode.style.position="relative";var e=webix.env.cssPrefix;
...
for(var r=0;r<t.length;r++)if(t[r]){var a=Math.min(s,Math.round(s*t[r]/e));n=this.Xs(r,a,!0)||n,s-=i[r].width,e-=t[r]}n&&this.rk(!0)}}},dn:function(t,e){var i=this.s.columns[t],s=i.minColumnWidth||10;if("header"!=e){var n=this.data.order.length;i.adjustBatch&&i.adjustBatch<n&&(n=i.adjustBatch);for(var r=this.data.order.slice(0,n),a=0;n>a;a++)r[a]=r[a]?this.Ek(this.getItem(r[a]),i,0):"";
s=Math.max(s,webix.html.getTextSize(r,"webix_table_cell webix_cell").width)}if("data"!=e)for(var a=0;a<i.header.length;a++){var h=i.header[a];if(h){var o=0;if(h.rotate)for(var l=0;l<(h.rowspan||1);l++)o+=this.Mt[l];var c="webix_table_cell webix_cell "+(h.css||"")+(h.rotate?"webix_measure_rotate":""),u=webix.html.getTextSize([h.text],c,o);
s=Math.max(s,h.rotate?u.height:u.width)}}return s+1+(webix.env.isIE?webix.skin.$active.layoutPadding.space:0)},bn:function(t,e,i){if(t>=0){var s=this.dn(t,e);return this.Xs(t,s,i)}},adjustColumn:function(t,e){this.bn(this.getColumnIndex(t),e)},adjustRowHeight:function(t,e){if(t){var i,s=this.getColumnConfig(t),n=webix.html.create("DIV",{
...
this.data.each(function(t){n.innerHTML=this.Ek(t,s,0),t.$height=Math.max(n.scrollHeight,this.s.rowHeight)},this),n=webix.html.remove(n),i&&webix.html.remove(i)}else{var r=new Array(this.data.order.length),a=this.config.columns,h=0;for(var o in this.data.pull)r[h]=0,h++;for(var l=0;l<a.length;l++){this.adjustRowHeight(a[l].id,!0);
var h=0;this.data.each(function(t,e){t.$height>r[h]&&(r[h]=t.$height),t.$height=r[h],h++})}}e||this.refresh()}}),webix.extend(webix.ui.datatable,{math_setter:function(t){return t&&this.en(),t},fn:"$",en:function(){webix.env.strict||(this.data.attachEvent("onStoreUpdated",webix.bind(this.gn,this)),this.data.attachEvent("onStoreLoad",webix.bind(this.hn,this)),
...
s[n].style.display=i?"none":""}},render:function(t){var e=webix.html.create("DIV");e.style.cssText="position:absolute; width:100%; height:100%; top:0px; left:0px;",t.appendChild(e);var i=webix.env.isIE?"":"src='data:image/gif;base64,R0lGODlhEgASAIAAAP///////yH5BAUUAAEALAAAAAASABIAAAIPjI+py+0Po5y02ouz3pwXADs='";
...
};webix.patterns={phone:{mask:"+# (###) ###-####",allow:/[0-9]/g},card:{mask:"#### #### #### ####",allow:/[0-9]/g},date:{mask:"####-##-## ##:##",allow:/[0-9]/g}},webix.extend(webix.ui.text,{$init:function(e){if((e.pattern||e.format)&&(this.attachEvent("onKeyPress",function(e,s){if(!(s.ctrlKey||s.altKey||this.nH)){
...
margin:3,id:t},on:{onBeforeDrop:function(t){var e=t.from,i=t.to,s=e.getTopParentView();if(s===this.getTopParentView()){var n="select_one"!=i.s.action;s.select(t.source,n),s.QE()}return!1},onItemDblClick:function(){return this.getTopParentView().AF(this.config.action)}}};return this.s.list&&webix.extend(n,this.s.list,!0),
...
var i;if("object"!=typeof t&&(t=[t]),e)for(i=0;i<t.length;i++)this.uF[t[i]]=!0;else for(i=0;i<t.length;i++)delete this.uF[t[i]];this.callEvent("onChange",[]),this.QE()},xF:function(t,e){webix.ui.freeze(webix.bind(t,this),!1),e&&(this.$$("left").s.autoheight||this.$$("right").s.autoheight)&&this.resize();
...
function(){var t={};webix.jsonp=function(e,i,s,n){var r=webix.promise.defer(),a="webix_jsonp_"+webix.uid(),h=document.createElement("script");h.id=a,h.type="text/javascript";var o=document.getElementsByTagName("head")[0];"function"==typeof i&&(n=s,s=i,i={}),i||(i={}),i.jsonp="webix.jsonp."+a,webix.jsonp[a]=function(){
s&&s.apply(n||window,arguments),r.resolve(arguments[0]),window.clearTimeout(t[a]),delete t[a],h.parentNode.removeChild(h),s=o=n=h=null,delete webix.jsonp[a]},t[a]=window.setTimeout(function(){r.reject(),delete webix.jsonp[a]},webix.jsonp.timer);var l=[];for(var c in i)l.push(c+"="+encodeURIComponent(i[c]));
return e+=(-1==e.indexOf("?")?"?":"&")+l.join("&"),h.src=e,o.appendChild(h),r},webix.jsonp.timer=3e3}(),webix.markup={namespace:"x",attribute:"data-",dataTag:"li",Ys:/-([a-z])/g,Zs:function(t){return t[1].toUpperCase()},Lr:{width:!0,height:!0,gravity:!0,margin:!0,padding:!0,paddingX:!0,paddingY:!0,minWidth:!0,
maxWidth:!0,minHeight:!0,maxHeight:!0,headerRowHeight:!0},AA:{disabled:!0,hidden:!0},Mr:function(t,e){return webix.ui.hasMethod(t,e)},init:function(t,e,i){t=t||document.body;for(var s=[],n=this.Nr(t),r=n.html,a=null,h=n.length-1;h>=0;h--)s[h]=n[h];for(var h=0;h<s.length;h++){var o;o=this.Or(s[h],r),o.$scope=i,
a=this.Pr(o,s[h],r,e)}return a},parse:function(t,e){"string"==typeof t&&(t=webix.DataDriver[e||"xml"].toObject(t,t));var i=this.Nr(t,e);return this.Or(i[0],i.html)},Pr:function(t,e,i,s){return s?t.container=s:(t.container=e.parentNode,webix.html.remove(e)),this.Mr(t.view,"setPosition")&&delete t.container,
...
if(!i){var n=this.Tr(t,e);if("ui"==n)for(var r=t.childNodes,a=0;a<r.length;a++)if(1==r[a].nodeType)return this.Or(r[a],e);i={view:n},e&&"table"==t.tagName.toLowerCase()&&(i.data=t,i.datatype="htmltable",s=!0)}for(var h="cols"==i.view||"rows"==i.view||this.Mr(i.view,"addView"),o=[],l=0,c=!(e||t.style),u=t.firstChild;u;){
...
},$setValue:function(t){if(t=t||"","extra"==this.config.mode)return this.setValueHere(t);var e=t.split(this.config.separator);if(e.length!=this.eu.length+1){this.removeSection(),this.setValueHere.call(this,e[0]);for(var i=1;i<e.length;i++){var s=this.addSection();webix.$$(s).setValueHere(e[i])}}else{
this.setValueHere(e[0]);for(var i=0;i<this.eu.length;i++)webix.$$(this.eu[i]).setValueHere(e[i+1])}},yB:function(t){var e=this.config.master?webix.$$(this.config.master):this,i=e.getValue(),s=e.s.value;i!==s&&(e.s.value=i,e.callEvent("onChange",[i,s]))},addSection:function(){var t=this.config,e={labelWidth:t.labelWidth,
inputWidth:t.inputWidth,width:t.width,label:t.label?"&nbsp;":"",view:this.name,mode:"extra",value:"",icon:"minus-circle",suggest:t.suggest||null,master:t.id};webix.extend(e,t.subConfig||{},!0);var i=this.getParentView().addView(e);return webix.$$(i).attachEvent("onChange",this.yB),this.eu.push(i),this.callEvent("onSectionAdd",[i,this.eu.length]),
i},removeSection:function(t){for(var e=this.config.master?webix.$$(this.config.master):this,i=e.eu.length-1;i>=0;i--){var s=e.eu[i];t&&s!=t||(e.eu.removeAt(i),this.getParentView().removeView(s),e.callEvent("onSectionRemove",[s,i+1]))}},on_click:{webix_input_icon:function(t,e,i){if("extra"==this.config.mode){
this.removeSection(this.config.id);var s=this.getParentView().getChildViews();s[s.length-1].focus(),this.yB()}else webix.$$(this.addSection()).focus();return!1}},$init:function(){this.eu=webix.toArray([]),this.attachEvent("onKeyPress",this.DD)},$render:function(t){this.$setValue(t.value)}},webix.ui.text),
webix.protoUI({name:"organogram",defaults:{scroll:"auto",ariaLabel:"lines"},$init:function(){this.x.className+=" webix_organogram",this.v=document.createElement("DIV"),this.$ready.push(this.Av),webix.extend(this.data,webix.TreeStore,!0),this.data.provideApi(this,!0)},ad:"webix_dg_id",on_click:{webix_organogram_item:function(t,e){
this.s.select&&("multiselect"==this.s.select||this.s.multiselect?this.select(e,!1,t.ctrlKey||t.metaKey||"touch"==this.s.multiselect,t.shiftKey):this.select(e),this.Qh=!1)}},on_context:{},on_dblclick:{},Av:function(){this.y.style.position="relative",this.data.attachEvent("onStoreUpdated",webix.bind(this.render,this));
...
return this.data.branch[t.id]&&(e+=this._x(t.id)),e},LA:function(){return this.type.listMarginX||this.type.listMarginY},_x:function(t,e){var i,s,n,r,a="",h=this.data.branch[t],o=this.data.Me[t],l=this.getItem(t),c=l?l.$type:!1;if(e=e||0,"list"===c&&(e+=this.type.listMarginX),t||(this.ay=[],this.$xy={},
r=this.$width-2*this.type.padding,this.$xy[0]={totalWidth:r,start:this.type.padding,width:0,height:0,left:r/2,top:this.type.padding||0}),h){n=this.$xy[t],"list"!=c||this.LA()||(a+=this.type.templateListStart.call(this,l,this.type,o));var u=0,d=0;for(i=0;i<h.length;i++){s=h[i],r=this.by[s];var f=this.getItem(s);
f.open==webix.undefined&&(f.open=!0),"list"==c&&this.data.addMark(s,"list_item","",1,!0);var b=this.cy(s);if("list"==c){var p=0;this.LA()?p=this.type.listMarginY:i||(p=this.type.marginY),this.$xy[s]={totalWidth:r,start:n.start,width:this.type.width,height:b,left:n.start+r/2-this.type.width/2+e,top:i?this.$xy[h[i-1]].top+this.$xy[h[i-1]].height+p+d:n.top+n.height+p
},d=this.data.branch[s]?this.GG(s):0}else this.$xy[s]={totalWidth:r,start:n.start+u,width:this.type.width,height:b,left:n.start+u+r/2-this.type.width/2,top:n.top+n.height+(t?this.type.marginY:0)};a+=this.pg(f),u+=r}for(i=0;i<h.length;i++)s=h[i],this.data.branch[s]&&this.getItem(s).open?a+=this._x(s,e):l&&("list"!=l.$type?this.ay.push(this.$xy[s].top+this.$xy[s].height):i==h.length-1&&this.ay.push(this.$xy[s].top+this.$xy[s].height));
var x=0;for(var g in this.$xy){var f=this.$xy[g];x=Math.max(f.left+f.width,x)}this.y.style.width=x+this.type.padding+this.type.marginX/2+"px","list"!=c||this.LA()||(a+=this.type.templateListEnd(l,this.type,o))}return a},GG:function(t){for(var e=this.data.branch[t],i=0,s=0;s<e.length;s++)i+=this.cy(e[s])+this.type.listMarginY,
this.data.branch[e[s]]&&(i+=this.GG(e[s]));return i+this.type.marginY},cy:function(t){var e=this.getItem(t),i=this.type.height;return"function"==typeof i&&(i=i.call(e,this.type,this.data.Me[t])),this.dy||(this.dy=webix.html.create("div"),this.y.appendChild(this.dy)),this.dy.className=this.type.classname(e,this.type,this.data.Me[t]),
this.dy.style.cssText="width:"+this.type.width+"px;height:"+i+("auto"==i?"":"px")+";",this.dy.innerHTML=this.type.template.call(this,e,this.type,this.data.Me[t]),this.dy.scrollHeight},ey:function(){var t={},e=this.type.width,i=this.type.marginX;return this.data.each(function(s){t[s.id]=e+i;var n=this.getParentId(s.id);
if(n&&"list"!=this.getItem(n).$type)for(;n;){var r=this.branch[n];t[n]=0;for(var a=0;a<r.length;a++)t[n]+=t[r[a]]||0;n=this.getParentId(n)}}),this.by=t,t},getItemNode:function(t){if(this.t)return this.t[t];this.t={};for(var e=this.y.childNodes,i=0;i<e.length;i++){var s=e[i].getAttribute(this.ad);if(s&&(this.t[s]=e[i]),
-1!=e[i].className.indexOf("webix_organogram_list")&&!this.LA())for(var n=e[i].childNodes,r=0;r<n.length;r++)s=n[r].getAttribute(this.ad),s&&(this.t[s]=n[r])}return this.getItemNode(t)},Ne:function(t){return this.v.innerHTML=this.pg(t),this.v.firstChild},render:function(t,e,i){if(this.isVisible(this.s.id)&&!this.$blockRender){
if("update"==i){var s=this.getItemNode(t),n=this.t[t]=this.Ne(e);return webix.html.insertBefore(n,s),webix.html.remove(s),!0}return this.callEvent("onBeforeRender",[this.data])&&(this.ey(),this.t=null,this.y.innerHTML=this._x(0),this.dy=null,this.y.style.height=Math.max.apply(Math,this.ay)+this.type.padding+"px",
this.fy(),this.resize(),this.callEvent("onAfterRender",[])),!0}},fy:function(){this.canvas&&this.canvas.clearCanvas(!0),this.canvas=new webix.Canvas({container:this.y,name:this.name,title:this.s.ariaLabel,width:this.y.offsetWidth,height:this.y.offsetHeight}),this.gy(0)},zo:function(t,e,i,s,n,r,a){t.strokeStyle=r,
t.lineCap="square",t.lineWidth=a,t.beginPath(),t.moveTo(e,i),t.lineTo(s,n),t.stroke(),t.lineWidth=1},gy:function(t,e){var i,s,n,r,a,h,o,l,c,u;this.config.layout;if(e||(e=this.canvas.getCanvas()),this.$xy&&(t=t||0,n=this.data.branch[t],s=this.getItem(t),n&&n.length)){if(r=this.$xy[t],t)if(h=parseInt(r.left+r.width/2,10)+.5,
o=parseInt(r.top+r.height,10),l=parseInt(r.top+r.height+this.type.marginY/2,10),"list"==s.$type){if(!this.LA())return l=parseInt(r.top+r.height+this.type.marginY,10),void this.zo(e,h,o,h,l,this.type.lineColor)}else this.zo(e,h,o,h,l,this.type.lineColor);for(o=parseInt(r.top+r.height+this.type.marginY/2,10)+.5,
i=0;i<n.length;i++)t&&(a=this.$xy[n[i]],"list"==s.$type&&this.LA()?(h=parseInt(r.left+this.type.listMarginX/2,10)+.5,i?i==n.length-1&&(u=h):c=h,l=parseInt(a.top+a.height/2,10),this.zo(e,h,o-this.type.marginY/2,h,l,this.type.lineColor),this.zo(e,h,l,h+this.type.listMarginX/2,l,this.type.lineColor)):(h=parseInt(a.left+a.width/2,10)+.5,
i?i==n.length-1&&(u=h):c=h,l=parseInt(a.top,10),this.zo(e,h,o,h,l,this.type.lineColor))),this.getItem(n[i]).open&&this.gy(n[i],e);t&&this.zo(e,c,o,u,o,this.type.lineColor)}},$getSize:function(t,e){var i=this.s.autowidth,s=this.s.autoheight;return i&&(t=this.y.offsetWidth+(this.y.offsetHeight>e&&!s?webix.ui.scrollSize:0)),
s&&(e=this.y.offsetHeight+(this.y.offsetWidth>t&&!i?webix.ui.scrollSize:0)),webix.ui.view.prototype.$getSize.call(this,t,e)},$setSize:function(t,e){webix.ui.view.prototype.$setSize.call(this,t,e)&&(this.y.style.width=this.$width+"px",this.y.style.height=this.$height+"px",this.render())},type:{width:120,
height:"auto",padding:20,marginX:20,marginY:20,listMarginX:0,listMarginY:0,lineColor:"#90caf9",classname:function(t,e,i){var s="webix_organogram_item ";return t.$css&&("object"==typeof t.$css&&(t.$css=webix.html.createCss(t.$css)),s+=" "+t.$css),i&&i.list_item&&(s+=" webix_organogram_list_item "),i&&i.$css&&(s+=i.$css),
s+=" webix_organogram_level_"+t.$level},listClassName:function(t){var e="webix_organogram_list webix_organogram_list_"+t.$level;return t.$listCss&&("object"==typeof t.$listCss&&(t.$listCss=webix.html.createCss(t.$listCss)),e+=" "+t.$listCss),e},template:webix.template("#value#"),templateStart:function(t,e,i){
var s="";if((!i||!i.list_item||e.listMarginX||e.listMarginY)&&this.$xy){var n=this.$xy[t.id];s+="width: "+n.width+"px; height: "+n.height+"px;",s+="top: "+n.top+"px; left: "+n.left+"px;"}return'<div webix_dg_id="'+t.id+'" class="'+e.classname.call(this,t,e,i)+'"'+(s?'style="'+s+'"':"")+'">'},templateEnd:webix.template("</div>"),
...
var o=this.iH;o.style.left=h.rx+"px",o.style.top=h.ry+"px",webix.extend(a,h,!0)}},webix.ui.gridlayout),webix.protoUI({name:"panel",$init:function(t){t.header&&t.body&&(t.body=[{template:t.header,type:"header",css:"webix_header panel_drag_header"},t.body]),t.header||webix.html.addCss(this.$view,"panel_drag_view"),
this.$ready.push(this.Py)},Py:function(){var t=this.getChildViews();if(1==t.length&&this.s.icon){var e=webix.html.create("div",{"class":"panel_icon"},"<span class='webix_icon fa-"+this.s.icon+" panel_icon_span'></span>");this.x.appendChild(e)}},body_setter:function(t){return this.rows_setter(webix.isArray(t)?t:[t]);
...
this.Rt){var f=this.getSpan(s.id,l.id);f&&f[4]&&f[0]==s.id&&f[1]==l.id&&(d=f[4])}d||(d=l.template(s,t.type,s[l.id],l,o),d||0===d||(d=""),r&&"string"==typeof d&&(c&&(d=d.replace(/<div class=.webix_tree_none.><\/div>/,u)),d=d.replace(a,"")),"string"==typeof d&&"csv"===e.export_mode&&(d=d.trim()),"string"!=typeof d||"excel"!==e.export_mode&&"csv"!==e.export_mode||(d=d.replace(/<br\s*\/?>/gm,"\n"))),
n.push(d)}"excel"==e.export_mode&&t.fj&&e.heights!==!1&&(s.$height&&s.$height!==webix.skin.$active.rowHeight||"all"==e.heights)&&(i.heights[h.length]=s.$height||this.config.rowHeight),h.push(n)},t),e.footer!==!1)for(var d=i[0].footer?i[0].footer.length:0,f=0;d>f;f++){for(var b=[],l=0;l<i.length;l++){
var p=i[l].footer[f];r&&(p=i[l].footer[f]=p.toString().replace(a,"")),b.push(p)}"excel"!=e.export_mode||!t.fj||e.heights===!1||t.Nt[f]===webix.skin.$active.barHeight&&"all"!=e.heights||(i.heights[h.length]=t.Nt[f]),"pdf"!==e.export_mode&&h.push(b)}return"excel"===e.export_mode&&e.docFooter&&(h=h.concat([[],[(e.docFooter.text||e.docFooter).toString()]]),
e.docFooter.height&&(i.heights[h.length-1]=e.docFooter.height)),h}function n(t){for(var e=[],i=0;i<t.length;i++)e.push({wch:t[i].width});return e}function r(t){return Math.round(25569+t/864e5)}function a(t,e){var i=t.getColumnConfig,s=t.Rt,n=[];if(i){if(e.header!==!1&&(n=h(t,e,"header",n)),s){var r=e.xCorrection||0,a=e.yCorrection||0;
for(var o in s){var l=s[o];for(var c in l){var u=t.getColumnIndex(c)-r,d=t.getIndexById(o)-a,f=u+l[c][0]-1,b=d+(l[c][1]-1);n.push({s:{c:u,r:d},e:{c:f,r:b}})}}}e.footer!==!1&&(n=h(t,e,"footer",n))}return n}function h(t,e,i,s){for(var n=t.config.columns,r=(e.docHeader?2:0)+("header"==i?0:(e.header!==!1?t.Mt.length:0)+t.count()),a=0;a<n.length;a++)for(var h=n[a][i],o=0;o<h.length;o++)h[o]&&(h[o].colspan||h[o].rowspan)&&s.push({
s:{c:a,r:o+r},e:{c:a+(h[o].colspan||1)-1,r:o+(h[o].rowspan||1)-1+r}});return s}function o(t,e,i){return i[t]&&i[t][e]?i[t][e]:""}function l(t){for(var e in t)t[e]={hpx:t[e],hpt:.75*t[e]};return t}function c(t,e,i,s){for(var a={},h={s:{c:1e7,r:1e7},e:{c:0,r:0}},c=0;c!=t.length;++c)for(var u=0;u!=t[c].length;++u){
h.s.r>c&&(h.s.r=c),h.s.c>u&&(h.s.c=u),h.e.r<c&&(h.e.r=c),h.e.c<u&&(h.e.c=u);var d={v:t[c][u]};if(null!==d.v){var f=XLSX.utils.encode_cell({c:u,r:c});d.v instanceof Date?(d.t="n",d.z=XLSX.SSF[p][14],d.v=r(d.v)):"boolean"==typeof d.v?d.t="b":"number"==typeof d.v||d.v&&!isNaN(1*d.v)?(d.v=1*d.v,d.t="n"):"="==d.v.charAt(0)?(d.t="n",
d.f=d.v,delete d.v):d.t="s",s&&(d.s=o(c,u,s)),a[f]=d}}return h.s.c<1e7&&(a["!ref"]=XLSX.utils.encode_range(h)),a["!rows"]=l(e.heights),a["!cols"]=n(e),i.length&&(a["!merges"]=i),a}function u(t){for(var e=new ArrayBuffer(t.length),i=new Uint8Array(e),s=0;s!=t.length;++s)i[s]=255&t.charCodeAt(s);return e;
}function d(t,e,i,s){i.header=webix.isUndefined(i.header)||i.header===!0?{}:i.header,i.footer=webix.isUndefined(i.footer)||i.footer===!0?{}:i.footer,i.table=i.table||{};var n=i.width||595.296,r=i.height||841.896;if(i.orientation&&"landscape"===i.orientation&&(r=[n,n=r][0]),i.autowidth){n=80;for(var a=0;a<t.length;a++)n+=t[a].width;
