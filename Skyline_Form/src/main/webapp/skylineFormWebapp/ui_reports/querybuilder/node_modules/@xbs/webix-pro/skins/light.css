...
.webix_popup_button.confirm div{font-size:17px;font-family:Arial;border:1px solid #6eb6ff;background:#2190ff;text-shadow:none!important;color:#fff!important;border-color:#cbe5e7!important}
...
.webix_inp_counter_next,.webix_inp_counter_prev{padding-left:6px;color:#555;font-size:17px;font-family:Arial;border:1px solid #6eb6ff;background:#6eb6ff;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0}
.webix_el_textarea textarea{height:100%;margin:0;padding:5px 10px;color:#555;resize:none;font-size:15px;font-family:Arial}
...
.webix_item_tab{display:table-cell;text-align:center;vertical-align:middle;overflow:hidden;cursor:pointer;border:1px solid transparent;border-left-width:0;background:#00abbb;-webkit-border-radius:0;-moz-border-radius-topleft:0;-moz-border-radius-bottomleft:0;-moz-border-radius-topright:0;-moz-border-radius-bottomright:0;border-radius:0;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
...
.webix_forminput legend{color:#555;line-height:28px;padding:3px 7.5px 3px 2px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;font-family:Arial;float:left}
.webix_slider_box{position:relative;padding:13px 10px 0;height:100%;float:left;border-radius:5px;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;margin-top:-13px}
...
::-webkit-scrollbar-button:vertical:increment{background:center center no-repeat,no-repeat #e5f9fa}
::-webkit-scrollbar-button:vertical:decrement{background:center center no-repeat,no-repeat #e5f9fa}
...
::-webkit-scrollbar-button:horizontal:increment{background:center center no-repeat,no-repeat #e5f9fa}
::-webkit-scrollbar-button:horizontal:decrement{background:center center no-repeat,no-repeat #e5f9fa}
...
.confirmButton{font-size:17px;font-family:Arial;border:1px solid #6eb6ff;background:#2190ff;text-shadow:none!important;color:#fff!important;border-color:#cbe5e7!important}
