...
(function ($) {
    ...
    var oAddNewRowButton, oDeleteRowButton, oUpdateRowButton, oConfirmRowAddingButton, oCancelRowAddingButton;
...
//            //Set the click handler on the "Update selected row" button
            oUpdateRowButton = $('#' + properties.sUpdateRowButtonId);
//            if (oUpdateRowButton.length != 0)
//                oUpdateRowButton.click(_fnOnRowUpdate);
//            else {
...
//            }
            ...
            //If update button exists disable it until some row is selected
    ...
    // send the ID value of the selected row to html hidden field rowID                    
//                     var sId = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]); 
//                    document.all.rowID.value = sId;
