...
* >>> t.s. 16-09-14: add in the servlet:  response.setHeader("Set-Cookie", "fileDownload=true; path=/"); 
* >>> client-side must import: <script src="js/comply_js/jquery.fileDownload.js" type="text/javascript"></script>
* >>> it's important to pass all relevant request parameters in the url string or the report will fail
* !!!!NOTE!!!!
* yp 27112014 bug in websphere(teva) http://stackoverflow.com/questions/6573524/ie-not-downloading-files-over-ssl http://stackoverflow.com/questions/6838050/remove-http-header-using-java-servlet-api
* also ...CookiesConfigureNoCache
