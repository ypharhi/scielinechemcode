...
<script src="../skylineFormWebapp/js/bl_Adama_js/ElementUploadFileImpBL.js?<spring:message code="Env" text="" />"></script>
<script defer src="../skylineFormWebapp/marvin/gui/lib/promise-1.0.0.min.js"></script>
<script defer src="../skylineFormWebapp/marvin/js/marvinjslauncher.js"></script>
