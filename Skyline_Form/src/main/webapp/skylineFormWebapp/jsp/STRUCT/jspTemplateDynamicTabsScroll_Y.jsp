...
<div style="width:100%;position:relative;float:left;">
	<div class="top-bar-container" style="width:100%;position:relative;float:left;">
		<%@ include file="./PageHeaderJsoTemplateForm.inc" %>
		<%@ include file="../include/includeMenu.jsp" %>
	</div>
	<!-- <div class="ui-widget-content ui-corner-all"> -->
		<div class="displayOnLoad" style="display:none;width:100%;position: relative;float: left;">
			<div id="tempalteTabs">
				<ul>
					@tempalteTabs@			
				</ul>
			...
			<div class="submit-button-row">
				...
				<div class="bottom-page-buttons">
					...
					${Optional11}
					${Optional12}
					<button class="button new-main-button" id="newButton" type="button" onclick="confirmWithOutSave(openWFDialog,[doNew]);">New</button>
					<button class="button save-main-button" id="saveButton" type="button" perm_attr="cu" onclick="doSave('@afterSave@')" style="margin-left: 15px;"><spring:message code="Save" /></button>																						
