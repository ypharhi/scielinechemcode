								...
								<tr>
									<td class="submit-button-row">
										<div style="float: left;">
											...
											${Optional11}
											${Optional12}
										<button  type="button" class="button" perm_attr="cu" style="display: none;" id="save_" onclick="doSave('@afterSave@')"><spring:message code="Save" text="Save" /></button>
										<button id="close_back" class="button" type="button" style="margin-left: 15px;display: none;" onclick="parent.$('#prevDialog').dialog('close');"><spring:message code="Close" text="Close" /></button>
									</td>									
								</tr>								
							</table>
						</td>
