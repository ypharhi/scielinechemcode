							...
							<table class="displayOnLoad" width="100%" style="display:none;">
								...
								<tr>
									<td class="submit-button-row">
											...
											<button class="button" id="backStageButton" perm_attr="cu" type="button" onclick="confirmPrevStage(doSaveWorkupnoMandatoryValidation,'@afterSave@', 'RETURN_PREV_STAGE_STATUS')" style="margin-left: 15px;">Save & Back</button>
											<button class="button" id="saveNextButton" perm_attr="cu" type="button" onclick="confirmNextStage(doSave,['@afterSave@', 'UPDATE_STAGE_STATUS'])" style="margin-left: 15px;"><spring:message code="SaveNext" /></button>
									</td>
							   </tr>
							</table>
						</td>
