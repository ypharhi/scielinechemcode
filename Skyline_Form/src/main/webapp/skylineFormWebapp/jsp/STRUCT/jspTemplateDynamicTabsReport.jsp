							...
							<table class="displayOnLoad" width="100%" style="display:none;">
								...
								<tr>
									<td style="text-align: center;line-height: 60px;">
											<button id="newButton" class="button" type="button" onclick="confirmWithOutSave(openWFDialog,[doNew]);">New</button>
											<button id="saveButton" class="button" perm_attr="cu" type="button" onclick="doSave('@afterSave@')" style="margin-left: 15px;"><spring:message code="Save" /></button>											
											<button id="close_back" class="button" type="button" style="margin-left: 15px;" onclick="parent.$('#prevDialog').dialog('close');"><spring:message code="Close" /></button>
											<!-- <button id="reportButton" class="button" type="button" style="margin-left: 15px;" onclick=""><spring:message code="Report" /></button> -->
