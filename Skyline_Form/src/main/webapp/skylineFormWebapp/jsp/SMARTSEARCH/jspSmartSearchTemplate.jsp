					...
					<tr>
						<td class="ui-widget-content ui-corner-all innerTD" colspan="10">
							<table class="displayOnLoad" width="100%" style="display:none;">
								<tr>
									<td class="innerTD">
									 <!--begin --><div style="height: calc(100vh - 100px);overflow-y: auto;">
									@body@
									<!--end --></div>
									</td>
								</tr>	
								<tr>
									<td class="submit-button-row">
										<div style="float: left;">
											...
											${Optional11}
											${Optional12}
										<button  type="button" class="button" perm_attr="cu" id="save_" onclick="elementSmartSearchSave(this)"><spring:message code="Save" text="Save" /></button>
