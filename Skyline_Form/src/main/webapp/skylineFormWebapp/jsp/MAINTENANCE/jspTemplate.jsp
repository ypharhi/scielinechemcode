...
<body>
   ...
   <table style="width:100%;">								
					...
					<tr>
						<td class="ui-widget-content ui-corner-all innerTD" colspan="10">
							<table class="displayOnLoad" width="100%" style="display:none;">
								<tr>
									<td class="innerTD">
									 <!--begin --><div style="height: calc(100vh - 190px);overflow-y: auto;">
									@body@
									<!--end --></div>
									</td>
								</tr>	
			...
			<!-- 							<button  type="button" class="button" id="save_" perm_attr="u" onclick="doSave('@afterSave@')"><spring:message code="Save" text="Save" /></button> -->
