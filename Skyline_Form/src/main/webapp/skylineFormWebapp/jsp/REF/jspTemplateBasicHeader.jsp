...
<body>
   ...
   <table style="width:100%;">
					<tr>
						<td>
<%@ include file="./PopupHeaderBasicHeader.inc" %>
						</td>
					</tr>									
					<tr>
						<td class="ui-widget-content ui-corner-all innerTD" colspan="10">
							<table class="displayOnLoad" width="100%" style="display:none;">
								<tr>
									<td class="innerTD">
									 <!--begin --><div id = "popupTemplate" style="height: calc(100vh - 190px);overflow-y: auto;">
									@body@
									<!--end --></div>
									</td>
								</tr>	
								<tr>
									<td class="submit-button-row">
										...
										${Optional11}
										${Optional12}
										<button  type="button" perm_attr="cu" class="button" id="save_" onclick="doSave('@afterSave@')"><spring:message code="Save" text="Save" /></button>
