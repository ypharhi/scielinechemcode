(function () {
        ...
        HeaderCellsDialog.prototype._switchLayout = function (tabType) {
            ...
            switch (tabType) {
                case "row":
                    ...
                    container.addClass("rowheader-property-grid-container");
                    break;
                case "col":
                    ...
                    container.removeClass("rowheader-property-grid-container");
                    break;
            }
        };
    ...
    var chartHiddenEmptyCellDialog = (function (_super) {
            ...
            return {
                ...
                buttons: [{
                    ...
                    click: function () {
                        ...
                        var displayNaAsBlank = $("#show-nan-as-empty").prop("checked");
                        self._applySetting(value === "connectData" ? 0 : (value === "gaps" ? 1 : 2), displayNaAsBlank, showHiddenRowsAndColumns);
                    }
                },
                {
                    text: designer.res.close,
        ...
        chartHiddenEmptyCellDialog.prototype._applySetting = function (index, displayNaAsBlank, showHiddenRowsAndColumnsVal) {
            this.hiddenAndEmptyCellsOptionCallBack(index, displayNaAsBlank, showHiddenRowsAndColumnsVal);
            this.close();
        }
        ...
        chartHiddenEmptyCellDialog.prototype._beforeOpen = function () {
            ...
            var displayNaAsBlank = this._acChart.displayNaAsBlank();
            if (index === 0) {
            ...
            $('#show-nan-as-empty').prop('checked', displayNaAsBlank);
