(function () {
    ...
    var SpreadSettingDialog = (function (_super) {
        ...
        SpreadSettingDialog.prototype._beforeOpen = function (args) {
            ...
            this._element.find("#setting-allowAutoCreateHyperlink").prop("checked", designer.wrapper.spread.options.allowAutoCreateHyperlink);
            ...
            this._element.find("#setting-CalcOnDemand").prop("checked", designer.wrapper.spread.options.calcOnDemand);
        ...
        SpreadSettingDialog.prototype._applySetting = function () {
            ...
            designer.wrapper.spread.options.allowAutoCreateHyperlink = this._element.find("#setting-allowAutoCreateHyperlink").prop("checked");
            ...
            designer.wrapper.spread.options.scrollbarAppearance = this._element.find("#setting-scrollbar-mobile").prop("checked") ? 1 /* GC.Spread.Sheets.ScrollbarAppearance.mobile */ : 0 /* GC.Spread.Sheets.ScrollbarAppearance.skin */;
            designer.wrapper.spread.options.calcOnDemand = this._element.find("#setting-CalcOnDemand").prop("checked");
    ...
    var InsertCellStatesDialog = (function (_super) {
        ...
        InsertCellStatesDialog.prototype._beforeOpen = function (args) {
            ...
            var range = ranges[0];
            range.row  = Math.max(0, range.row);
            range.col  = Math.max(0, range.col);
            $element.find(".cellstates-data-range").val(designer.CEUtility.parseRangeToExpString(range));
            } else {
