    ...
    (function (tabs) {
        ...
        var gcuitabs = (function (_super) {
                ...
                if (!o.disabledState && !o.disabled) {
                    this.anchors.bind(o.event + '.tabs', function () {
                        ...
                        if ($show.length) {
                            ...
                            self.load(self.anchors.index(this));
                        } else if($li.attr('class').indexOf('expand_compress_li')!=-1){//COMPLY-added this condition in order to prevent an exception when clicking the expandqcompress icon
            ...
            gcuitabs.prototype.select = function (index) {
                ...
                if ($("#hiddenRibbon").css("display") === "block" || $("#hiddenRibbon").css("display") === "inline-block") {
        ...
        var gcuiribbon = (function (_super) {
            ...
            gcuiribbon.prototype._showDropDownList = function (list, buttonEle) {
                ...
                if (list.is(":visible") && !list.find("li." + self.options.uiCSS.stateActive)) {
                    ...
                    self.showList = list;
                    self.isShow = true;
                    list.css("width", $.gcui.getTextAutoWidth(list) + 1);
                }
            };
