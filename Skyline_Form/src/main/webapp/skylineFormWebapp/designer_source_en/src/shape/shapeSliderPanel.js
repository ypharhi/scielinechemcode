(function () {
    ...
    var shapePropCheckGroup = ['locked', 'printObject', 'allowResize', 'allowRotate', 'allowMove', 'showHandle'];
    ...
    function PropertiesEditor(container, data, name, resources, propertiesChangedCallbck) {
        ...
        self.checkboxGroup = new CheckboxGroup(container,
            [resources.locked, resources.printObject, resources.allowResize, resources.allowRotate, resources.allowMove, resources.showHandle],
            shapePropCheckGroup, name, function (property, value) {
        ...
        self.updaterCheckGroupUI(5, data.allowResize);
        self.updaterCheckGroupUI(6, data.allowRotate);
        self.updaterCheckGroupUI(7, data.allowMove);
        self.updaterCheckGroupUI(8, data.showHandle);
    }
    ...
    PropertiesEditor.prototype.CheckgroupSelectionChanged = function (property, value) {
        ...
        var currentPropIndex = shapePropCheckGroup.indexOf(property);
                //'3' is dom locked option index
        if (result && currentPropIndex > -1) {
                //'4' is dom locked option index
            this.updaterCheckGroupUI(3 + currentPropIndex, result);
        }
    };
        ...
        switch (property) {
            ...
            case 'moveSizeRelationship':
                ...
                var newOption = {
                    ...
                    allowResize: shapes[0].allowResize(),
                    allowRotate: shapes[0].allowRotate(),
                    allowMove: shapes[0].allowMove(),
                    showHandle: shapes[0].showHandle()
                };
            ...
            if (getShapeType(shapes[i]) === 'groupShapeType') {
                ...
                switch (property) {
                    ...
                    case 'locked':
                        ...
                        break;
                    case 'allowResize':
                        valueCollection.push(shapes[i].allowResize());
                        break;
                    case 'allowRotate':
                        valueCollection.push(shapes[i].allowRotate());
                        break;
                    case 'allowMove':
                        valueCollection.push(shapes[i].allowMove());
                        break;
                    case 'showHandle':
                        valueCollection.push(shapes[i].showHandle());
                        break;
                    case 'moveSizeRelationship':
    ...
    SliderPanelDataManager.prototype.getSizeData = function (shapes) {
        ...
        var propertiesData = {
            ...
            data: {
                ...
                allowResize: this.getPropertyData(shapes, 'allowResize'),
                allowRotate: this.getPropertyData(shapes, 'allowRotate'),
                allowMove: this.getPropertyData(shapes, 'allowMove'),
                showHandle: this.getPropertyData(shapes, 'showHandle'),
            ...
            resources: {
                ...
                allowResize: designer.res.shapeSliderPanel.allowResize,
                allowRotate: designer.res.shapeSliderPanel.allowRotate,
                allowMove: designer.res.shapeSliderPanel.allowMove,
                showHandle: designer.res.shapeSliderPanel.showHandle,
