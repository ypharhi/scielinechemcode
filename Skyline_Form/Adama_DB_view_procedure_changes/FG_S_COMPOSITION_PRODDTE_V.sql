CREATE OR REPLACE VIEW FG_S_COMPOSITION_PRODDTE_V AS
...
(
    ...
    -- ,S.COMPOSITIONTYPE COMPOSITIONTYPE
     ...
     ,t.difference
     ,t.TABLETYPE
     ,s.PROJECT_ID as project_id_filter
      ...
      and t.TABLETYPE = 'productComposition'
)
...
,fg_get_material_list(c.invitemmaterial_id,5000, c.ROWTYPE,'false',is_autosave_in => 'true',formcode_in => c.formcode, project_id_scope_in => c.project_id_filter) as "Material_SMARTEDIT"
...
,'{"displayName":"'||fg_get_num_display(c.WW_P,4)||'","htmlType":"text"'
    ...
    ||',"isDisabled":"'||decode(c.EXPERIMENTSTATUSNAME,'Planned','true','false')||'","colCalcId":"actual"}' as "Actual Weight_SMARTEDIT"
    ,'{"displayName":"'||nvl(c.difference,'')|| '","dbColumnName":"difference","colCalcId":"difference"}' as "Difference_SMARTEDIT"
