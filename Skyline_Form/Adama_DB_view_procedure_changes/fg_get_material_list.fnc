create or replace function fg_get_material_list (selected_material_id_in in varchar,
                                                 top_num_in number, -- yp 14112021 - there is limitation of 500 for the UI in the parameter maxShownResults - in the bug 9252 - I change 20 to 500 in the else part
