create or replace view fg_s_manualresultsref_dt_v as
select "MANUALRESULTSREF_ID","FORM_TEMP_ID","PARENTID"
...
,t.ANALYTICRESULTTYPENAME as "Result Type"
...
from FG_S_MANUALRESULTSREF_ALL_V t, fg_files f
  where t.attachment = f.file_id(+)
--03012019 fixed order by /no changes/
