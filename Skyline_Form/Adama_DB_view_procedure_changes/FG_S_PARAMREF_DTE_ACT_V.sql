CREATE OR REPLACE VIEW FG_S_PARAMREF_DTE_ACT_V AS
...
,fg_get_num_display(t.PLANNEDVAL2,0,3) as "Planned Value 2"
 ...
 ,'{"displayName":"'||fg_get_num_display(t.VAL1,0,3)|| '","htmlType":"text","dbColumnName":"VAL1","autoSave":"true"}' as "Actual Value 1_SMARTNUM"
