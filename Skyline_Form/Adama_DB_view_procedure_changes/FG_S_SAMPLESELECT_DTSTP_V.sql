CREATE OR REPLACE VIEW FG_S_SAMPLESELECT_DTSTP_V AS
...
,'{"displayName":"","htmlType":"checkCharSample","dbColumnName":"characterizedSample","formCode":"'||s.FORMCODE||'","formId":"'||s.FORMID||'","group":"true","disabled":"false"}' as "Character Sample_SMARTEDIT" --yp 02022020 save to characterizedSample columns the formcode and formis not in use(?)
